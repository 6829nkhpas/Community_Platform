...
router.put('/profile', authMiddleware, async (req, res) => {
  try {
    ...
    const updateData = {
      ...
      skills: Array.isArray(skills) ? skills : (skills ? skills.split(',').map(skill => skill.trim()) : user.skills),
      languages: Array.isArray(languages) ? languages : (languages ? JSON.parse(languages) : user.languages),
